  ...
  return (
    <CardContainer href={href}>
      <div className="flex flex-col items-start">
        <div className="flex justify-center items-center w-10 h-10 mb-3 rounded-[24px] bg-[#f5f5f5] transition-all duration-300 group-hover:bg-[#eaeaea] group-hover:scale-110 group-hover:rotate-[-5deg]">
          {icon}
        </div>
        <h2 className="text-base font-semibold mb-1.5 text-black tracking-[-0.01em]">{title}</h2>
        {description && (
          <p className="text-xs leading-[1.4] text-[#666666] m-0">{description}</p>
        )}
      </div>
    </CardContainer>
  );
